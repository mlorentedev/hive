...
- [`runbooks/`](runbooks/) — operational procedures (e.g. the [architecture audit checklist](runbooks/audit-checklist.md) and the [daemon activation](runbooks/daemon-activation.md) guide)
