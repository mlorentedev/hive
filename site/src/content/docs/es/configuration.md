...
- **Requerido**
  ...
  - Un directorio de archivos markdown. La estructura `00_meta` / `10_projects` / `50_work` es opcional — sin ella, las herramientas de vault siguen funcionando pero el enrutamiento por scope es plano.
