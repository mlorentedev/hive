...
_ENABLE_STEPS = (
    ...
    "  2. Configure an OpenAI-compatible embeddings backend. Any provider\n"
    "     serving /v1/embeddings works; a hosted one looks like:\n"
    "       HIVE_EMBED_BASE_URL=https://api.your-provider.example/v1\n"
    "       HIVE_EMBED_MODEL=<an embedding model the provider serves>\n"
    "       HIVE_EMBED_API_KEY=<your-key>\n"
    "     Or a local runtime, so no data leaves your machine:\n"
